// Command FastlineVpn-mcp is an MCP server exposing the FastlineVpn
// SDK as MCP tools.
//
// Two tools are registered:
//
//	FastlineVpn_list  — list records of an entity
//	FastlineVpn_load  — load a single record of an entity
//
