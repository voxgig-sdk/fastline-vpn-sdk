...
function runner.env_override(m)
  local live = runner.getenv("FASTLINEVPN_TEST_LIVE")
  local override = runner.getenv("FASTLINEVPN_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FASTLINEVPN_TEST_EXPLAIN")
