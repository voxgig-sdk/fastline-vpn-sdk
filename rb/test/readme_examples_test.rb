...
#      offline in seeded test mode (FastlineVpnSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "FastlineVpn_sdk.rb")
  SDK_CLASS = "FastlineVpnSDK"
