# FastlineVpn SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FastlineVpnSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FastlineVpnSDK(...) and FastlineVpnSDK.test(...) become
#      FastlineVpnSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "fastlinevpn_sdk"
_SDK_CLASS = "FastlineVpnSDK"
