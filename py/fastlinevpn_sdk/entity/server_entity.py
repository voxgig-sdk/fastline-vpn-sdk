...
from fastlinevpn_sdk.fastlinevpn_types import (
    Server,
    ServerCreateData,
)
...
class ServerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ServerEntity(self._client, opts)
    ...
    def create(self, reqdata: ServerCreateData, ctrl=None) -> Server:
        utility = self._utility
