...
from fastlinevpn_sdk.utility import register

# Load features
from fastlinevpn_sdk.feature.base_feature import FastlineVpnBaseFeature
from fastlinevpn_sdk.features import _has_feature, _make_feature
...
class FastlineVpnSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = FastlineVpnUtility()
        self._utility = utility

        from fastlinevpn_sdk.config import shared_config
    ...
    def get_utility(self):
        return FastlineVpnUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FastlineVpnSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Server(self, data=None) -> "ServerEntity":
        ...
        from fastlinevpn_sdk.entity.server_entity import ServerEntity
        return ServerEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "FastlineVpnSDK":
        if sdkopts is None:
            sdkopts = {}
