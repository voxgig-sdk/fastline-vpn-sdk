# FastlineVpn TypeScript SDK



The TypeScript SDK for the FastlineVpn API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Server()` — each with a small set of operations (`create`)
...
| `tester(testopts?, sdkopts?)` | `FastlineVpnSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `FastlineVpnSDK.test(testopts?, sdkopts?)` | `FastlineVpnSDK` | Create a test-mode client. |
...
| `client` | `client(): FastlineVpnSDK` | Return the parent SDK client. |
...
fastline-vpn/
├── src/
│   ├── FastlineVpnSDK.ts        # Main SDK class
