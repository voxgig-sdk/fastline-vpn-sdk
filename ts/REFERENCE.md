# FastlineVpn TypeScript SDK Reference

Complete API reference for the FastlineVpn TypeScript SDK.
...
```ts
new FastlineVpnSDK(options?: object)
```
...
#### `FastlineVpnSDK.test(testopts?, sdkopts?)`
...
**Returns:** `FastlineVpnSDK` instance in test mode.
...
Return the parent `FastlineVpnSDK` instance.
