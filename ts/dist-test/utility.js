...
function envOverride(m) {
    if ('TRUE' === process.env.FASTLINE_VPN_TEST_LIVE ||
        'TRUE' === process.env.FASTLINE_VPN_TEST_OVERRIDE) {
    ...
    m.FASTLINE_VPN_TEST_EXPLAIN = process.env.FASTLINE_VPN_TEST_EXPLAIN || m.FASTLINE_VPN_TEST_EXPLAIN;
    return m;
}
