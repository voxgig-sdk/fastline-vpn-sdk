...
// FastlineVpn SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FastlineVpnMakeRequest
{
    public static function call(FastlineVpnContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FastlineVpnResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FastlineVpnResponse($fetched);
        } else {
