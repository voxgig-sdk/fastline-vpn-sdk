...
// FastlineVpn SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FastlineVpnSDK::test)
...
{
    private const SDK_CLASS = 'FastlineVpnSDK';
    ...
    private const SDK_BASE = 'fastlinevpn_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../fastlinevpn_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
