...
// FastlineVpn SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FastlineVpnOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FastlineVpnOmni::structfix($now, Struct::undef()))
                        !== json_encode(FastlineVpnOmni::structfix($val, Struct::undef()))) {
