...
// FastlineVpn SDK netsim feature
...
class FastlineVpnNetsimFeature extends FastlineVpnBaseFeature
{
    ...
    private function _simulate(FastlineVpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FastlineVpnContext $ctx, array $applied): void
    {
        $client = $this->client;
