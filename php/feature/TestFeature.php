...
// FastlineVpn SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FastlineVpnTestFeature extends FastlineVpnBaseFeature
{
    ...
    public function init(FastlineVpnContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FastlineVpnContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = FastlineVpnParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FastlineVpnContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FastlineVpnContext $ctx, $op, $args): array
    {
