...
class FastlineVpnRbacFeature extends FastlineVpnBaseFeature
{
    ...
    private function _required(FastlineVpnContext $ctx): ?string
    {
    ...
    private function _reject(FastlineVpnContext $ctx, string $required): void
    {
    ...
    private function _track(FastlineVpnContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
