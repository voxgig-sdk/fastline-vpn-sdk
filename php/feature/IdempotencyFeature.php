...
// FastlineVpn SDK idempotency feature
...
class FastlineVpnIdempotencyFeature extends FastlineVpnBaseFeature
{
    ...
    private function _mutating(FastlineVpnContext $ctx): bool
    {
