...
class FastlineVpnCacheFeature extends FastlineVpnBaseFeature
{
    ...
    private function _through(FastlineVpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
