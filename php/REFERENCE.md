# FastlineVpn PHP SDK Reference

Complete API reference for the FastlineVpn PHP SDK.
...
#### `FastlineVpnSDK::test($testopts = null, $sdkopts = null)`
...
#### `get_utility(): FastlineVpnUtility`
