...
// FastlineVpn SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FastlineVpnTransformResponse
{
    public static function call(FastlineVpnContext $ctx): mixed
    {
        ...
        $transform = FastlineVpnHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
