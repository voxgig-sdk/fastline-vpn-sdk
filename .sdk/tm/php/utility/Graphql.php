...
// FastlineVpn SDK utility: graphql
//
...
class FastlineVpnGraphql
{
    ...
    // equivalent.
    public static function body(FastlineVpnContext $ctx): mixed
    {
    ...
    public static function errors(FastlineVpnContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
