...
// FastlineVpn SDK utility: fetcher

class FastlineVpnFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FastlineVpnSDK/1.0)';
    ...
    public static function call(FastlineVpnContext $ctx, string $fullurl, array $fetchdef): array
    {
