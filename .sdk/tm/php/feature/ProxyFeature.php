...
class FastlineVpnProxyFeature extends FastlineVpnBaseFeature
{
    ...
    public function init(FastlineVpnContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FastlineVpnContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
