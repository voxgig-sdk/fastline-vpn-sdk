...
// FastlineVpn SDK ratelimit feature
...
class FastlineVpnRatelimitFeature extends FastlineVpnBaseFeature
{
    ...
    private function _acquire(FastlineVpnContext $ctx): void
    {
    ...
    private function _track(FastlineVpnContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
