...
// FastlineVpn SDK timeout feature
...
class FastlineVpnTimeoutFeature extends FastlineVpnBaseFeature
{
    ...
    private function _with_timeout(FastlineVpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FastlineVpnContext $_ctx, float $ms): void
    {
        $client = $this->client;
