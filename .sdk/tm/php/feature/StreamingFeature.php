...
// FastlineVpn SDK streaming feature
...
class FastlineVpnStreamingFeature extends FastlineVpnBaseFeature
{
    ...
    private function _iterate(FastlineVpnResult $result): \Generator
    {
    ...
    private function _streamable(FastlineVpnContext $ctx): bool
    {
