...
// FastlineVpn SDK clienttrack feature
...
class FastlineVpnClienttrackFeature extends FastlineVpnBaseFeature
{
    ...
    public function PostConstruct(FastlineVpnContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FastlineVpn-SDK';
