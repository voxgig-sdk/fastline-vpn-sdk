...
from projectname_sdk.core.control import FastlineVpnControl
...
class FastlineVpnContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, FastlineVpnSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FastlineVpnResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FastlineVpnResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FastlineVpnError(code, msg, self)
