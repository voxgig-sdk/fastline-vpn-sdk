...
|---|---|---|
| `ts/` | @voxgig-sdk/fastline-vpn-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/fastline-vpn-sdk \
      --repository voxgig-sdk/fastline-vpn-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/fastline-vpn-sdk` shows it, and
`npm trust revoke @voxgig-sdk/fastline-vpn-sdk --id=<id>` removes it.
