...
func registerSDKWords(r *eng.Registry, client *sdk.FastlineVpnSDK) {
...
func runOp(client *sdk.FastlineVpnSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
