...
func NewServerEntity(client *core.FastlineVpnSDK, entopts map[string]any) *ServerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ServerEntity) GetName() string { return e.name }
...
func (e *ServerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ServerEntity) Deleted() bool {
	return e.deleted
}


func (e *ServerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewServerEntity(e.client, opts)
}

func (e *ServerEntity) Data(args ...any) any {
...
func (e *ServerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Server; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ServerEntity) DataTyped(data ...Server) Server {
	if len(data) > 0 {
		return typedFrom[Server](e.Data(asMap(data[0])))
	}
	return typedFrom[Server](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Server (all fields
// optional at the wire level).
func (e *ServerEntity) MatchTyped(match ...Server) Server {
	if len(match) > 0 {
		return typedFrom[Server](e.Match(asMap(match[0])))
	}
	return typedFrom[Server](e.Match())
}
...
func (e *ServerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ServerEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ServerEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ServerEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ServerCreateData and returns an Server. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ServerEntity) CreateTyped(reqdata ServerCreateData, ctrl map[string]any) (Server, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Server{}, err
	}
	return typedFrom[Server](res), nil
}



func (e *ServerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ServerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ServerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
